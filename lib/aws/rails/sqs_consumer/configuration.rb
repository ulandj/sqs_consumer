    ...
    module SqsConsumer
      ...
      class Configuration
        ...
        DEFAULTS = {
          ...
          queues: {},
          logger: ::Rails.logger,
          message_group_id: 'SqsConsumerGroup'
        }
        ...
        def config_file
          file = ::Rails.root.join("config/sqs_consumer/#{::Rails.env}.yml")
          file = ::Rails.root.join('config/sqs_consumer.yml') unless file.exist?
          file
        end
